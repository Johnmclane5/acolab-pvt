...
from .modules import authorize, cancel_mirror, mirror_leech, status, torrent_select, ytdlp, rss, shell, eval, users_settings, bot_settings, speedtest, images, mediainfo, broadcast
...
async def restart(client, message):
    ...
    proc1 = await create_subprocess_exec('pkill', '-9', '-f', '-e', 'gunicorn|aria2c|openstack|ffmpeg|rclone')
